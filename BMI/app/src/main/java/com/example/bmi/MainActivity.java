...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        h = (EditText)findViewById(R.id.tt1);                           // 取得身高物件
        w = (EditText)findViewById(R.id.tt2);                           // 取得體重物件
        Button submit = (Button)findViewById(R.id.button2);             // 取得按鈕物件 如果ID有誤請回到res->Layout查看預設Button是多少
        ...
        submit.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View arg0) {
                        ...
                        || "".equals(w.getText().toString())) )
                {
                    ...
                    TextView result = (TextView)findViewById(R.id.t3);// 取得 顯示結果 物件
                    fh = fh/100; // 計算BMI
                    fh = fh*fh;  // 計算BMI
                    ...
                    TextView dia = (TextView)findViewById(R.id.t4);// 取得 顯示診斷 物件
